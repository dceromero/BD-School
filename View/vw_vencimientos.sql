...
CONVERT(VARCHAR(10),cu.FechaVigencia, 23) fechaVigencia,  convert(int,dbo.Periodo(GETDATE())) periodo, dbo.Fnc_NroLogros(year(GETDATE()),cu.Grado,cu.CodAsignatura) cantLogros, 
